...
if answer == "left":
    ...
    answer = input("You come to a bridge, it looks wobbly, do you want to cross it or head back (back/cross)? ")

    if answer == "back":
        print("You go back and lose.")
    elif answer == "cross":
        answer = input("You cross the bridge and meet a stranger. Do you talk to the stranger (yes/no)?  ")
